...
import {GetPaginatedFeedUCInput} from "../../../../../../semana-16/aula-69/src/business/usecases/feed/getPaginatedFeed";
...
export class GetPaginatedAllVideosUC {
    ...
    async execute(input: GetPaginatedAllVideosUCInput):Promise<GetPaginatedAllVideosUCOutput> {
